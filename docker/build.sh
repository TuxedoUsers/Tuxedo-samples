...
if [ ! -e p19927652_121300_Linux-x86-64.zip ]
then
  echo "Download the latest Tuxedo rolling patch kit and"
  echo "drop the file p19927652_121300_Linux-x86-64.zip in this folder before"
  echo "building this Tuxedo Docker container!"
  exit 
fi
...
if [ "$?" = "0" ]
	...
	echo "sudo docker run -i -t oracle/tuxedo /bin/bash"
    else
