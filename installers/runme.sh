#!/bin/sh
# Shell script to build and run simpapp.  It assume Tuxedo has been installed to:
# ~/tuxhome/tuxedo12.1.3.0.0   If not, invoke this script with a single argument indicating
# the location of TUXDIR.
#
# Usage: source runme.sh
#
if [ ! -z "$1" ]
    then
	export TUXDIR=$1
